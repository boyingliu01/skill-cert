...
class TestReporter:
    ...
    def test_suggestions_cost_high_delta(self):
        ...
        reporter = Reporter()
        metrics = {"l1_trigger_accuracy": 0.9, "l2_with_without_skill_delta": 0.9,
                   "l3_step_adherence": 0.9, "l4_execution_stability": 0.9}
        drift = {"drift_detected": False}
        cost = {"cost_delta_pct": 0.8, "cost_efficiency": 0.05}
        suggestions = reporter._generate_suggestions(metrics, drift, "PASS", 0.9, cost_analysis=cost)
    ...
    def test_suggestions_latency_overhead(self):
        ...
        suggestions = reporter._generate_suggestions(metrics, drift, "PASS", 0.9, latency_analysis=latency)
    ...
    def test_suggestions_all_good(self):
        ...
        reporter = Reporter()
        metrics = {"l1_trigger_accuracy": 0.95, "l2_with_without_skill_delta": 0.9,
                   "l3_step_adherence": 0.95, "l4_execution_stability": 0.95}
        drift = {"drift_detected": False}
    ...
    def test_verdict_drift_caveats(self):
        ...
        metrics = {
            "overall_score": 0.70,
            "l1_trigger_accuracy": 0.70, "l2_with_without_skill_delta": 0.70,
            "l3_step_adherence": 0.70, "l4_execution_stability": 0.70,
            "metrics_breakdown": {
        ...
        drift = {"drift_detected": False, "highest_severity": "none",
                 "average_variance": 0.0, "max_variance": 0.0, "overall_verdict": "PASS_WITH_CAVEATS"}
    ...
    def test_json_report_includes_optional_sections(self):
        ...
        metrics = {
            "overall_score": 0.85,
            "l1_trigger_accuracy": 0.9, "l2_with_without_skill_delta": 0.8,
            "l3_step_adherence": 0.85, "l4_execution_stability": 0.9,
            "l7_cost_efficiency": {"cost_per_eval": 0.01, "total_cost": 0.10,
                                    "cost_with_skill": 0.06, "cost_without_skill": 0.04,
                                    "cost_delta_pct": 0.5, "cost_efficiency": 0.4},
            "l8_latency": {"with_skill": {"p50": 5.0, "p95": 8.0, "mean": 5.5},
                            "without_skill": {"p50": 3.0, "p95": 6.0, "mean": 3.5},
                            "overhead_pct": 50, "slow_with_skill": 0, "slow_without_skill": 0},
            "reliability": {"total_evals": 10, "success_rate": 0.9, "error_rate": 0.1,
        ...
        maintainability = {"total_score": 80, "grade": "B", "readability_score": 25,
                           "completeness_score": 30, "freshness_score": 25,
                           "readability_details": {"avg_line_length": 80, "max_depth": 2, "todo_count": 0},
                           "completeness_details": {"has_workflow": True, "has_anti_patterns": True, "has_triggers": True},
                           "freshness_details": {"outdated_refs": 0}}
        drift = {"drift_detected": False, "highest_severity": "none",
                 "average_variance": 0.0, "max_variance": 0.0, "overall_verdict": "PASS"}
        config = {"total_evaluations": 10, "avg_pass_rate": 0.85, "models": "model-a", "timestamp": ""}
        _, json_report = reporter.generate_report(metrics, drift, config, maintainability=maintainability)
    ...
    def test_multi_skill_with_conflicts(self):
        ...
        reporter = Reporter()
        metrics = {
            "overall_score": 0.8, "l1_trigger_accuracy": 0.9,
            "l2_with_without_skill_delta": 0.8, "l3_step_adherence": 0.85,
        ...
        multi = {
            "skill_count": 3, "overall_risk": "moderate",
            "summary": "Some conflicts detected",
            "trigger_conflicts": 2, "prompt_contamination_conflicts": 1, "token_overflow_conflicts": 0,
            "conflicts": [
                {"severity": "moderate", "conflict_type": "trigger_overlap",
                 "skill_a": "skill-a", "skill_b": "skill-b", "description": "Overlapping triggers"},
            ],
        }
    ...
    def test_multi_skill_without_conflicts(self):
        ...
        reporter = Reporter()
        metrics = {
            "overall_score": 0.9, "l1_trigger_accuracy": 0.9,
            "l2_with_without_skill_delta": 0.9, "l3_step_adherence": 0.9,
            "l4_execution_stability": 0.9,
            "metrics_breakdown": {
                "l1_details": {"total_trigger_evals": 0, "passed_trigger_evals": 0, "trigger_accuracy": 0.0},
                "l2_details": {"with_skill_avg_pass_rate": 0.0, "without_skill_avg_pass_rate": 0.0, "improvement_percentage": 0.0},
        ...
        multi = {"skill_count": 2, "overall_risk": "none", "summary": "No conflicts",
                 "trigger_conflicts": 0, "prompt_contamination_conflicts": 0,
                 "token_overflow_conflicts": 0, "conflicts": []}
        md, json_r = reporter.generate_report_with_multi_skill(metrics, drift, config, multi)
        assert "Multi-Skill Analysis" in md
    ...
    def test_stress_report(self):
        ...
        reporter = Reporter()
        metrics = {
            "overall_score": 0.85, "l1_trigger_accuracy": 0.9,
            "l2_with_without_skill_delta": 0.8, "l3_step_adherence": 0.85,
            "l4_execution_stability": 0.9,
            "metrics_breakdown": {
                "l1_details": {"total_trigger_evals": 0, "passed_trigger_evals": 0, "trigger_accuracy": 0.0},
        ...
        stress = {
            "verdict": "PASS", "scalability_score": 85.0,
            "total_evals": 100, "completed": 98, "failed": 2,
            "timed_out": 0, "errored": 2, "completion_rate": 0.98,
            "fairness_ratio": 0.95,
    ...
    def test_stress_report_no_model_counts(self):
        ...
        config = {"total_evaluations": 10, "avg_pass_rate": 0.85, "timestamp": ""}
        stress = {
            "verdict": "FAIL", "scalability_score": 30.0,
            "total_evals": 100, "completed": 50, "failed": 50,
            "timed_out": 10, "errored": 40, "completion_rate": 0.5,
            "fairness_ratio": 0.3,
            "latency": {"avg": 15.0, "min": 1.0, "max": 60.0, "median": 12.0, "p95": 55.0, "p99": 60.0},
    ...
    def test_multi_skill_with_to_dict_conflicts(self):
        ...
        class MockConflict:
            def to_dict(self):
                return {"severity": "high", "conflict_type": "token_overflow",
                        "skill_a": "A", "skill_b": "B", "description": "Overflow"}
        ...
        multi = {
            "skill_count": 2, "overall_risk": "high",
            "summary": "Token overflow", "trigger_conflicts": 0,
            "prompt_contamination_conflicts": 0, "token_overflow_conflicts": 1,
